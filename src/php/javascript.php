        ...
        var obscura = {
            ...
            styles: {
                ...
                image: {
                    ...
                    "cursor": "url('http://jspc29.x-matter.uni-frankfurt.de/trbweb/modules/obscura/images/zoom-in.svg'), pointer"
                },
                black: {
            ...
            show: function() {
                ...
                $("<img>", {
                    "src": "http://jspc29.x-matter.uni-frankfurt.de/trbweb/modules/obscura/images/minimize.svg",
                    "alt": "Minimize",
                    "title": "Minimize",
                    "role": "button",
                    "aria-label": "Minimize"
                ...
                bg.css({
                    "opacity": 1,
                    "cursor": "url('http://jspc29.x-matter.uni-frankfurt.de/trbweb/modules/obscura/images/zoom-out.svg'), pointer"
                });
            },
            hide: function() {
                $("#obscura-bg").remove();
